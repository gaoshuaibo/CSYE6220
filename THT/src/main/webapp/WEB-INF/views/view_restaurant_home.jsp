	...
	<div id="page_1">
		...
		<div id="content_1">
			<div id="div_home">
				...
				<a href="/tht/order/view/restaurant">Your orders</a><br> <a
					href="/tht/profile/view/restaurant">Your profile</a><br> <a
					href="/tht/dish/view/restaurant">Your menu</a><br>
				<form id="signout_form_r"
